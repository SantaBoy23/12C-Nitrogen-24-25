...
void initialize() {
  ...
  ez::as::auton_selector.autons_add({
    ...
    {"Safe Ring Side Blue\n\nSafe/Quals Ring Side for Blue with ring. Start on Ring Side.", RingSideQualsBlue},
    {"Safe Ring Side Red\n\nSafe/Quals Ring Side for Red with ring. Start on Ring Side.", RingSideQualsRed},
    {"Safe Ring Side Blue No Ring\n\nSafe/Quals Ring Side for Blue with ring. Start on Ring Side. NO RING", RingSideQualsBlueNoRing},
    {"Safe Ring Side Red No Ring\n\nSafe/Quals Ring Side for Red with ring. Start on Ring Side. NO RING", RingSideQualsRedNoRing},
