...
void initialize() {
  ...
  ez::as::auton_selector.autons_add({
    ...
    {"Safe Ring Side Blue No Ring\n\nSafe/Quals Ring Side for Blue NO RING. Start on Ring Side. NO RING", RingSideQualsBlueNoRing},
    {"Safe Ring Side Red No Ring\n\nSafe/Quals Ring Side for Red NO RING. Start on Ring Side. NO RING", RingSideQualsRedNoRing},
