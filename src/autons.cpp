...
//move forward
  ...
  chassis.pid_turn_set(-132.25_deg, TURN_SPEED);
  chassis.pid_wait();
  intake.move(0);

  //move to center rings and drop doinker
  chassis.pid_drive_set(-29_in, 90, true);
  ...
  chassis.pid_wait_quick_chain();
  ClampDown(false);
  chassis.pid_turn_set(0_deg, TURN_SPEED); //used to be -3
  chassis.pid_wait();
...
void SoloAWPAltRed () {
  ...
  //turn towards mogo
  chassis.pid_turn_set(0_deg, TURN_SPEED);
  chassis.pid_wait_quick_chain(); //wasn't quick before
  ...
  //turn towards centered rings
  chassis.pid_turn_set(40_deg, TURN_SPEED); //used to be 42.5
  chassis.pid_wait();
...
//move forward
  ...
  //move to rings and stop intake
  intake.move(127);
  chassis.pid_drive_set(-23_in, DRIVE_SPEED, true); //was -22
  chassis.pid_wait();
  intake.move(0);
  ...
  //turn towards centered rings
  chassis.pid_turn_set(43_deg, TURN_SPEED); //used to be 42.5
  chassis.pid_wait();

  //drive to centered rings and reset lb
  LiftHome();
  chassis.pid_drive_set(-13.45_in, DRIVE_SPEED, true);
  chassis.pid_wait();
  ...
  //move to center rings and drop doinker
  chassis.pid_drive_set(-30.5_in, 90, true);
  chassis.pid_wait_until(-10_in);
  DoinkerRightDrop(true);
  chassis.pid_wait();
  ...
  //turn, move back, drop goal, and turn to goal
  chassis.pid_turn_set(180_deg, TURN_SPEED);
  chassis.pid_wait_quick_chain();
...
void GoalSideQualsBlue() {
  ...
  chassis.pid_wait_quick_chain();
  chassis.pid_drive_set(11_in, 90, true);
  chassis.pid_wait();
  chassis.pid_drive_set(-11_in, 105, true);
  chassis.pid_wait_quick_chain();
...
void RingSideQualsBlue() {
  ...
  chassis.pid_turn_set(-152_deg, TURN_SPEED); //used to be -154
  chassis.pid_wait_quick_chain();
  IntakeMove(127);
  ...
  chassis.pid_turn_set(-120_deg, TURN_SPEED); //was 116
  chassis.pid_wait();
  chassis.pid_drive_set(-28_in, 100, true);
  chassis.pid_wait_quick_chain();
  ...
  //normal ending
  //move out of corner, and turn towards alliance rings
  ...
  chassis.pid_turn_set(-284_deg, TURN_SPEED); //used to be 288
  chassis.pid_wait();
  
  
  //start intake, drive to alliance rings and drop left doinker
  IntakeMove(127);
  chassis.pid_drive_set(-27.5_in, DRIVE_SPEED, true);
  chassis.pid_wait_until(-26.75);
  DoinkerRightDrop(true);
  chassis.pid_wait();
...
void RingSideQualsRed() {
  ...
  //turn to ring and start intake
  chassis.pid_turn_set(151_deg, TURN_SPEED);
  chassis.pid_wait_quick_chain();
  IntakeMove(127);

  //drive to stack and drop doinker
  DoinkerLeftDrop(true);
  chassis.pid_drive_set(-28_in, 90, true); //was drive speed
  chassis.pid_wait_until(-20_in);
  DoinkerLeftDrop(true);
  ...
  //go forwards then turn towards corner rings
  chassis.pid_drive_set(8.25_in, DRIVE_SPEED, true);
  chassis.pid_wait_quick_chain();
  chassis.pid_turn_set(50_deg, TURN_SPEED);
  chassis.pid_wait_quick_chain();
  ...
  chassis.pid_turn_set(286_deg, TURN_SPEED); //used to be 288
  chassis.pid_wait_quick_chain();

  //start intake, drive to alliance rings and drop left doinker
  IntakeMove(127);
  chassis.pid_drive_set(-26.5_in, DRIVE_SPEED, true);
  chassis.pid_wait_until(-25.75);
  DoinkerLeftDrop(true);
  chassis.pid_wait();
...
void RingSideQualsBlueNoRing() {
  ...
  //move out of corner, and turn towards ladder
  chassis.pid_drive_set(15_in, DRIVE_SPEED, true);
  chassis.pid_wait_quick_chain();
  chassis.pid_drive_set(-11_in, DRIVE_SPEED, true);
  chassis.pid_wait_quick_chain();
  ...
  chassis.pid_turn_set(-230_deg, TURN_SPEED); //used to be 288
  chassis.pid_wait_quick_chain();

  //put up lb and move into ladder
  LiftMoveTo(1000);
...
void BlueGoalNeutralStake() {
  ...
  //move forward towards neutral stake
  chassis.pid_drive_set(-40_in, DRIVE_SPEED, true);
  chassis.pid_wait();
  ...
  //Move away from alliance stake then reset LB
  chassis.pid_drive_set(20_in, DRIVE_SPEED, true);
  chassis.pid_wait();
  LiftHome();

  //Turn intake towards rings
  chassis.pid_turn_set(-45_deg, TURN_SPEED);
  chassis.pid_wait();

  //start intake and move into rings
  IntakeMove(127);
  chassis.pid_drive_set(-20_in, DRIVE_SPEED, true);
  chassis.pid_wait();

  //stop intake with ring in intake, then do 180
  IntakeMove(0);
  chassis.pid_turn_set(45_deg, TURN_SPEED);
  chassis.pid_wait();
  ...
  //turn towards corner then start intake
  ...
  //back out of corner then move in again
  chassis.pid_drive_set(9_in, DRIVE_SPEED, true);
  chassis.pid_wait_quick_chain();
  chassis.pid_drive_set(-8_in, DRIVE_SPEED, true);
  chassis.pid_wait();

  //turn towards alliance ring
  chassis.pid_turn_set(288_deg, TURN_SPEED);
  chassis.pid_wait();

  //drive to alliance rings and drop left doinker
  chassis.pid_drive_set(-26.5_in, DRIVE_SPEED, true);
  chassis.pid_wait_until(-25.75);
  DoinkerLeftDrop(true);
  chassis.pid_wait();
...
void RedRingNeutralStake() {
  ...
  //back away from wall stake, turn away from wall stake towards ring stacks, then reset LB
  chassis.pid_drive_set(7_in, DRIVE_SPEED, true);
  chassis.pid_wait();
  ...
  //drop doinker, move into ring stack
  DoinkerRightDrop(true);
  chassis.pid_drive_set(-10_in, DRIVE_SPEED, true);
  chassis.pid_wait();

  //back up then turn towards ring
  chassis.pid_drive_set(23_in, DRIVE_SPEED, true);
  chassis.pid_wait();
  chassis.pid_turn_set(270_deg, TURN_SPEED);
  chassis.pid_wait();

  //start intake and move into rings, then stop intake
  IntakeMove(127);
  chassis.pid_drive_set(-20_in, DRIVE_SPEED, true);
  ...
  //do 180, move forward and clamp goal
  ...
  //Turn towards corner rings and lift doinker
  chassis.pid_turn_set(45_deg, TURN_SPEED);
...
void RingSideElimsRed() {
  ...
  chassis.pid_drive_set(-4_in, DRIVE_SPEED, true); //used to be -4.5
  chassis.pid_wait_quick_chain();
  chassis.pid_drive_set(14_in, DRIVE_SPEED, true);
  chassis.pid_wait_quick_chain();
  ...
  */
  ...
  //turn goal towards positive corner
  chassis.pid_turn_set(-260_deg, TURN_SPEED);
  chassis.pid_wait();

  //drive towards pos corner
...
void RingSideElimsBlue() {
  ...
  chassis.pid_wait_quick_chain();
  pros::delay(200);
  chassis.pid_drive_set(-8_in, DRIVE_SPEED, true); //was -15
  chassis.pid_wait_quick_chain();

  //turn in general direction of corner
  chassis.pid_turn_set(175_deg, TURN_SPEED); //was 160
  chassis.pid_wait();

  //drive over to corner
  chassis.pid_drive_set(-10_in, DRIVE_SPEED, true); //was -5 //was -12
  chassis.pid_wait_quick_chain();
  ...
  //drive into corner and drive back
  chassis.pid_drive_set(-4_in, DRIVE_SPEED, true); //used to be -3.8
  chassis.pid_wait_quick_chain();
  chassis.pid_drive_set(14_in, DRIVE_SPEED, true);
  chassis.pid_wait_quick_chain();
  ...
  //turn towards tower and put up lb slightly
  LiftMoveTo(600);
  ...
  */
  ...
  //drive a bit forward
  chassis.pid_drive_set(4_in, DRIVE_SPEED, true); //was 2.1
  chassis.pid_wait();
